        ...
        <div id="login">
            <div id="login-form">
                <a id="login-logo" href="<?php echo get_bloginfo('url'); ?>">
                    <img src="<?php echo get_bloginfo('template_directory').'/image/login_bg.jgp';?>" />
                </a>
                <form>
...
<div
    id="login"
    style="background-image:url('<?php echo get_bloginfo('template_directory').'/image/login_bg.jpg';?>')">
    <div class="login__form__block">
        <div class="login__form">
            <a class="login__wife" href="<?php echo get_bloginfo('url'); ?>">
                <img src="<?php echo get_bloginfo('template_directory').'/image/login_wife.png';?>" />
            </a>
            <form>
                <div class="input__el">
                    <input type="text" name="user" id="user" />
                    <div class="input__placeholder"><span>用户名/邮箱</span></div>
                </div>
                <div class="input__el">
                    <input type="password" name="password" id="password" />
                    <div class="input__placeholder"><span>密码</span></div>
                </div>
                <div class="input__el" style="margin-bottom: 15px;">
                    <div class="login-radio" data-value="0">
                        <span class="login-radio-circle"></span>
                        <span class="login-radio-label">remember me</span>
                        <input type="hidden" class="login-radio-input" name="remember" id="remember" />
